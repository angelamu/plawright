...
test('test web table', async ({ page }) => {
 ...
 for(let row of rows){
   ...
   const countryWherePeopleSpeakPortueguese = countries.filter(country  =>country.primaryLanguage ==='Portuguese')
   console.log('Countries where people speak portugues', countryWherePeopleSpeakPortueguese)
